...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "erviceRpc\022N\n\rGetFrindsList\022\035.fixbug.GetF"
...
void FriendServiceRpc::GetFrindsList(::google::protobuf::RpcController* controller,
                         const ::fixbug::GetFriendsListRequest*,
                         ::fixbug::GetFriendsListResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFrindsList() not implemented.");
  done->Run();
}
...
void FriendServiceRpc_Stub::GetFrindsList(::google::protobuf::RpcController* controller,
